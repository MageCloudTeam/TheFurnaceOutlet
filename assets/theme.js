 ...
 (function (factory) {
  ...
  var ProductVariants = /*#__PURE__*/function () {
    ...
    _createClass(ProductVariants, [{
      ...
      key: "_attachListeners",
      value: function _attachListeners() {
        let similarContentTab = this.element.querySelector('.similar_products_tab');
        let arrItemSimilar = similarContentTab.querySelectorAll('.product-item');

        if(arrItemSimilar.length == 0){
          this.element.querySelector('.similar_products').style.display = 'none'
        }
